...
function writeblogposts(call) {
    ...
    do {
        ...
        $(share).attr("onclick", "copyToClipboard('" + window.location.href.split('?')[0] + "?id=" + posts[3] + "')");
        $(share).append("<span class='material-icons'>link</span><div class='url-tooltip'>" + getlang()[0][39] + "</div>");
        var tweet = document.createElement("a");
        $(tweet).attr("target", "_blank");
        $(tweet).attr("href", "https://twitter.com/intent/tweet?url=" + window.location.href.split('?')[0].replaceAll(":", "%3A").replaceAll("/", "%2F") + "%3Fid%3D" + posts[3] + "&text=" + posts[0].replaceAll(" ", "+"));
        ...
        $(reddit).attr("href", "https://reddit.com/submit?url=" + window.location.href.split('?')[0].replaceAll(":", "%3A").replaceAll("/", "%2F") + "%3Fid%3D" + posts[3] + "&title=" + posts[0].replaceAll(" ", "+"));
        ...
        $(telegram).attr("href", "https://t.me/share/url?url=" + window.location.href.split('?')[0].replaceAll(":", "%3A").replaceAll("/", "%2F") + "%3Fid%3D" + posts[3] + "&text=" + posts[0].replaceAll(" ", "+"));
        ...
        $(facebook).attr("href", "https://facebook.com/sharer/sharer.php?u=" + window.location.href.split('?')[0].replaceAll(":", "%3A").replaceAll("/", "%2F") + "%3Fid%3D" + posts[3]);
